...
<style>
  ...
  *{ box-sizing:border-box; -webkit-print-color-adjust:exact; print-color-adjust:exact; }
  ...
  body.cursive .wcard .w{ font-size:48px; }
  ...
  body.font-cursive-standard .wcard .w{ font-size:50px; }
  ...
  /* ---------- Print sheet ---------- */
  .sheet{ background:#fff; margin:16px auto; padding:12mm; width:297mm; min-height:210mm;
  ...
  /* ---------- Word cards (cut grid) ---------- */
  .wordgrid{ display:grid; grid-template-columns:repeat(auto-fill,10cm);
             border-top:1px dashed var(--cut); border-left:1px dashed var(--cut); }
  .wcard{ position:relative; width:10cm; height:7cm; border-right:1px dashed var(--cut); border-bottom:1px dashed var(--cut);
          display:flex; align-items:center; justify-content:center; padding:6px 4px;
          break-inside:avoid; }
  .wcard .w{ font-size:42px; font-weight:700; letter-spacing:.5px; }
